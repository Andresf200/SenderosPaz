    ...
    <article>
        <div class="image col-4 align-items-center justify-content-center ">
            <div class="contenedor_image shadow-lg bg-white rounded-4" >
                <img class="personal" src="<?php echo RUTA_URL.'img/mascotas.jpg'?>"  width="394px" alt="">
            </div>
        </div>
        <div class="information_article col-8">
            <div class="title">
                <center><h1>Plan de Mascotas<Center></Center></h1></center>
            </div>
            <div class="texto">
                <center><h3>    Protege a tu mascota, ellos también hacen parte de tu familia.
                    </h3></center>
                <br>
                <br>
