    ...
    <article>
        <div class="image col-4 align-items-center justify-content-center ">
            <div class="contenedor_image shadow-lg bg-white rounded-4" >
                <img class="personal" src="<?php echo RUTA_URL.'img/Ert.jpg'?>"  width="394px" alt="">
            </div>
        </div>
        <div class="information_article col-8">
            <div class="title">
                <center><h1>Convenio Especial ERT</h1></center>
            </div>
            <div class="texto">
            <center><h3>
                Para los usuarios de la Empresa Regional de Telecomunicaciones en el Valle cobro a través de la factura ERT
            </h3></center>
                <br>
                <br>
