    ...
    <article>
        <div class="image col-4 align-items-center justify-content-center ">
            <div class="contenedor_image shadow-lg bg-white rounded-4" >
                <img class="personal" src="<?php echo RUTA_URL.'img/diamante.jpg'?>"  width="394px" alt="">
            </div>
        </div>
        <div class="information_article col-8">
            <div class="title">
                <center><h1>Titulo Diamante</h1></center>
            </div>
            <div class="texto">
            <center><h3>Senderos integra un producto para tu adulto mayor, este título ha sido creado para personas de 60 años en adelante, este servicio es transferible.
            </h3></center>
                <br>
                <br>
